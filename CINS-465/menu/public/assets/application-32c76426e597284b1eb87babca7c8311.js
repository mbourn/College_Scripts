...
function hider(x) {
  if (document.getElementById(x)) {
    if (document.getElementById(x+'-show').style.display != 'none'){
      document.getElementById(x+'-show').style.display = 'none';
      document.getElementById(x).style.display = 'block';
    } else {
      document.getElementById(x+'-show').style.display = 'inline';
...
function toggle(y, x) {
  if(document.getElementBuId(x).style.display == "block") {
    document.getElementBuId(x).style.display = "none";
    document.getElementBuId(y).innerHTML = "show";
  }
  else {
    document.getElementBuId(x).style.display = "block";
    document.getElementBuId(y).innerHTML = "hide";
  }
}
